...
# Code below is for finding mean
...
#Code below is for finding median

new_data.sort()
if n% 2 == 0 :
    median1 = float(new_data1[n//2])
    median2 = float(new_data1[n//2-1])
    median = (median1+median2)/2
else: 
    median = new_data1[n//2]
    print(n)
print('median is : '+ str(median))


# Code below is for finding the mode
